...
function convertUnicodeToBijoy(text) {
    ...
    const u2bJukta = {
        ...
        'চ্চ':'”P', 'চ্ছ':'”Q', 'জ্জ':'¾', 'জ্ব':'R¦', 'ঝ্ঝ':'S&S', 'দ্ঘ':'`&N', 'ন্ত':'šÍ', 'ন্থ':'š’', 'ল্প':'í', 'ল্ব':'j&e', 'ল্ম':'j&g', 'ল্ল':'jø', 'ল্ফ':'j&d', 'ল্ট':'ë',
        'ধ্ব':'aŸ', 'শ্ব':'k¦', 'ত্ব':'Z¡', 'থ্ব':'_¡', 'ম্ন':'¤œ', 'শ্ম':'k¥', 'দ্য':'`¨', 'ন্ত্র':'š¿', 'ম্প্র':'¤cÖ', 'স্থ্য':'¯’¨', 'ষ্ট্র':'ó«', 
...
function convertBijoyToUnicode(text) {
    ...
    const b2uJukta = {
        ...
        'aŸ':'ধ্ব', 'k¦':'শ্ব', 'Z¡':'ত্ব', '_¡':'থ্ব', '¤œ':'ম্ন', 'k¥':'শ্ম',
