...
function convertUnicodeToBijoy(text) {
    ...
    const u2bJukta = {
        ...
        'ত্ত':'Ë', 'ত্থ':'Ì', 'ত্র':'Î', 'দ্দ':'Ï', 'দ্ধ':'×', 'দ্ব':'Ø', 'দ্ম':'Ù', 'ন্দ':'›`', 'ন্ধ':'Ü', 'ধ্রু':'aªæ', 'ন্ন':'bœ', 'ন্ব':'b¦', 'ন্ম':'b¥', 'ন্দ্র':'›`«', 'দ্র':'`ª',
        ...
        'শ্র':'kÖ', 'ক্র':'µ', 'গ্র':'MÖ', 'প্র':'cÖ', 'ড্র':'W«', 'ট্র':'U«', 'ফ্র':'d«', 'ব্র':'eª', 'ধ্রু':'aªæ'
        ...
        'ত্যু':'Zz¨', 'প্যু':'cz¨', 'ফ্যু':'dz¨', 'ভ্যু':'fz¨', 'হ্যু':'n~¨', 'ক্যু':'Kz¨', 'গ্যু':'Mz¨', 'চ্যু':'Pz¨', 'জ্যু':'Rz¨', 'ড্যু':'Wz¨', 'দ্যু':'`z¨', 'ধ্যু':'az¨', 'ব্যু':'ez¨', 'ল্যু':'jz¨', 'শ্যু':'k~¨', 'ত্যূ':'Z‚¨'
    };
...
function convertBijoyToUnicode(text) {
    ...
    const b2uJukta = {
        ...
        'Ky¨':'ক্যু', '¸¨':'গ্যু', 'Pz¨':'চ্যু', 'Rz¨':'জ্যু', 'Wz¨':'ড্যু',
