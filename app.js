...
function convertUnicodeToBijoy(text) {
    ...
    const u2b = {
        ...
        "ক্ন": "K&b", "ক্ম": "K&g", "ক্যু": "Ky¨", "ক্য": "K¨", "ক্র": "µ", "ক্ল": "K¬",
        "খ্ব": "L¡", "খ্র": "L«", "খ্যু": "Ly¨", "খ্য": "L¨",
        ...
        "ত্ম্য": "Z¥¨", "ত্ম": "Z¥", "ত্ব": "Z¡", "ত্র্য": "Î¨", "ত্র": "Î",
        ...
        "ন্দ্র": "›\x60ª", "ন্দ্ব": "›Ø", "ন্দ": "›\x60", "ন্ধ্য": "Ü¨", "ন্ধ": "Ü",
        "ন্ন": "bœ", "ন্ব": "š^", "ন্ম": "b¥", "ন্ত্ব": "š—¡", "ন্তু": "š‘",
        "ন্ত্য": "šÍ¨", "ন্ত": "š—", "ন্ত্র": "š¿", "ন্থ": "š’", "ন্য": "b¨",
        "ন্ট": "›U", "ন্ঠ": "Ú", "ন্ড্র": "Û«", "ন্ড": "Û",

        "প্ট": "Þ", "প্ত": "ß", "প্ন": "cœ", "প্প": "à", "প্স": "á",
        "প্যু": "cz¨", "প্য": "c¨", "প্র": "cÖ", "প্ল": "c­",
        "ফ্র": "d«", "ফ্ল": "d¬", "ফ্যু": "dz¨", "ফ্য": "d¨",

        "ব্দ": "ã", "ব্ধ": "ä", "ব্ব": "eŸ", "ব্জ": "â", "ব্র": "eª", "ব্ল": "e­",
        "ব্যু": "ey¨", "ব্য": "e¨", "ভ্র": "å", "ভ্যু": "fz¨", "ভ্য": "f¨",

        "ম্প্র": "¤cÖ", "ম্প": "¤ú", "ম্ফ": "ç", "ম্ব": "¤^", "ম্ভ্র": "¤£", "ম্ভ": "¤¢",
        "ম্ম": "¤§", "ম্ন": "gœ", "ম্র": "g«", "ম্য": "g¨", "ম্ল": "¤­",

        "ল্ক": "é", "ল্গ": "ê", "ল্ট": "ë", "ল্ড": "ì", "ল্প": "í", "ল্ফ": "î",
        "ল্ব": "j¦", "ল্ম": "j¥", "ল্ল": "jø", "ল্যু": "jy¨", "ল্য": "j¨",

        "গু": "¸", "রু": "iæ", "রূ": "iƒ", "শু": "ï", "হু": "û", "হৃ": "ü",
        ...
        "স্ক্র": "¯Œ", "স্ক": "¯‹", "স্খ": "ö", "স্ট্র": "÷«", "স্ট": "÷",
        "স্ত্র": "¯¿", "স্ত্য": "¯Í¨", "স্তু": "¯‘", "স্ত": "¯Í",
        "স্থ্য": "¯’¨", "স্থ": "¯’", "স্ন": "mœ", "স্প": "¯ú", "স্ফ": "ù",
        ...
        "বৈ": "‰e", "সৈ": "‰m", "কৈ": "‰K", "লৈ": "‰j", "মৈ": "‰g", "শৈ": "‰k", "হৈ": "‰n",
...
function convertBijoyToUnicode(text) {
    ...
    const b2u = {
        "ª¨": "্র্য", "i¨": "র‌্য",
        "¶g": "ক্ষ্ম", "²": "ক্ষ্ম", "¶¨": "ক্ষ্য", "¶z": "ক্ষু", "¶‚": "ক্ষূ", "¶": "ক্ষ",

        "k¥": "শ্ম", "kÖ": "শ্র", "k¦": "শ্ব", "kœ": "শ্ন", "k~¨": "শ্যু", "k¨": "শ্য", "k­": "শ্ল",
        "›\x60ª": "ন্দ্র", "›\x60«": "ন্দ্র", "›\x60": "ন্দ", "›Ø": "ন্দ্ব",
        "š¿": "ন্ত্র", "š—¡": "ন্ত্ব", "šÍ¨": "ন্ত্য", "š—": "ন্ত", "šÍ": "ন্ত", "š‘": "ন্তু", "š’": "ন্থ",
        "™¢": "দ্ভ", "˜M": "দ্গ", "˜N": "দ্ঘ", "˜¡": "দ্ব", "Ø": "দ্ব", "Ï": "দ্দ", "×": "দ্ধ", "Ù": "দ্ম",
        ...
        "¯’¨": "স্থ্য", "¯’": "স্থ", "mœ": "স্ন", "¯ú": "স্প", "ù": "স্ফ", "¯^": "স্ব", "¯§": "স্ম", "¯­": "স্ল", "m¨": "স্য", "m«": "স্র", "mø": "স্ল",

        "û": "হু", "nè": "হ্ণ", "ý": "হ্ন", "nŸ": "হ্ব", "n«": "হ্র", "n¨": "হ্য", "n¬": "হ্ল", "ü": "হৃ",

        "•": "ঙ্", "æ": "ু", "‚": "ূ", "ƒ": "ূ", "„": "ৃ", "…": "ৃ", "†": "ে", "‡": "ে", "ˆ": "ৈ", "‰": "ৈ", "Š": "ৗ",

        "Av": "আ", "A": "অ", "B": "ই", "C": "ঈ", "D": "উ", "E": "ঊ", "F": "ঋ", "G": "এ", "H": "ঐ", "I": "ও", "J": "ঔ",
        "K": "ক", "L": "খ", "M": "গ", "N": "ঘ", "O": "ঙ", "P": "চ", "Q": "ছ", "R": "জ", "S": "ঝ", "T": "ঞ", "U": "ট", "V": "ঠ",
        "W": "ড", "X": "ঢ", "Y": "ণ", "Z": "ত", "_": "থ", "\x60": "দ", "a": "ধ", "b": "ন", "c": "প", "d": "ফ", "e": "ব", "f": "ভ", "g": "ম",
